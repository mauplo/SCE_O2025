@echo off
echo 4_testCA.bat
echo Ejecuta el estresador para probar el servicio de Casa de Artesanias (CA)
echo.
echo Uso:
echo   4_testCA.bat [NumClientes] [NumSolicitudesPorCliente] [HOSTNAME]
echo.
...
set POJO=pojo_ca.Pojo_CA
set POJOJAR=4_Pojo_CA.jar
